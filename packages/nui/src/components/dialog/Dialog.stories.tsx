...
const GlobalApiDemo = () => {
  const handleAlert = async () => {
    await nui.alert('Your session is about to expire.', {
  ...
  return (
    ...
    >
      <div>
        <h3 style={{ fontFamily: 'sans-serif', marginBottom: '1rem' }}>
          Dialog API
        </h3>
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          <Button onClick={handleDangerConfirm} variant="danger">
            Show Danger Confirm
          </Button>
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          <Button
            onClick={() => nui.success('Quick success!')}
            variant="outline"
          >
            Quick Success
          </Button>
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'The `nui` object provides imperative, globally accessible methods for triggering WAI-ARIA compliant Dialogs and Toasts from anywhere in your application—even outside of React components.',
      },
    },
  },
