...
export const WithDefaultValue: Story = {
  render: () => {
    const file = new File(['hello'], 'example-document.pdf', {
    ...
    const Wrapper = () => {
      ...
      return (
        ...
        >
          ...
          >
            <p
              style={{ margin: 0, fontSize: '14px', fontFamily: 'sans-serif' }}
            >
...
export const InteractiveTest: Story = {
  play: async ({ canvasElement }) => {
    ...
    const file = new File(['(⌐□_□)'], 'cool-sunglasses.txt', {
      type: 'text/plain',
    });
    ...
    const removeBtn = canvas.getByRole('button', {
      name: /Remove cool-sunglasses\.txt/i,
    });
