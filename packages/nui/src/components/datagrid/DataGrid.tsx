...
export function DataGrid<T>({
 ...
 ---------------------------------------------------- */
  ...
  const isAllPageSelected =
    ...
    paginatedRows.every((r, i) => selection.has(getRowId(r, i)));
 ...
 ---------------------------------------------------- */
  return (
    <div
      className={cn(
        'datagrid flex flex-col w-full border border-default rounded-lg bg-surface shadow-sm font-sans overflow-hidden',
        className
      )}
    >
      <div
        ...
        >
          ...
          <thead className="bg-subtle border-b border-default">
            <tr role="row">
              {selectable && (
                <th
                  className="px-4 py-3 font-medium text-subtle whitespace-nowrap select-none w-12 text-center pr-0"
                  scope="col"
                >
                  <Checkbox
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        col.sortable &&
                          'cursor-pointer hover:text-primary group focus-visible:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--nui-fg-default)] rounded-sm',
                    ...
                    >
                      ...
                      {col.sortable && (
                        <span
                          className={cn(
                            'text-muted opacity-30 transition-all duration-200 group-hover:opacity-100',
                            isSorted && 'opacity-100 text-primary'
                          )}
                        >
              ...
              {showActions && (
                <th
                  className="px-4 py-3 font-medium text-subtle whitespace-nowrap select-none text-right"
                  scope="col"
                ></th>
              )}
            </tr>
              ...
              paginatedRows.map((row, idx) => {
                ...
                return (
                  <tr
                    ...
                    className={cn(
                      'datagrid-row border-b border-default last:border-b-0 transition-colors duration-150 ease-in-out hover:bg-subtle',
                      isSelected && 'bg-subtle hover:bg-muted',
                      isFocused &&
                        'outline-none ring-2 ring-inset ring-primary',
                      onRowClick &&
                        'cursor-pointer focus-visible:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--nui-fg-default)]'
                    )}
                    onClick={() => {
                  ...
                  >
                    ...
                    {showActions && (
                      <td
                        className="px-4 py-3 text-default align-middle text-right whitespace-nowrap"
                        onClick={(e) => e.stopPropagation()}
                      >
      ...
      {!disablePagination && totalPages > 1 && (
        <div className="datagrid-pagination flex items-center justify-between px-4 py-3 border-t border-default bg-surface rounded-b-lg">
