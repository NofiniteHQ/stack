...
describe('Pagination Component', () => {
  ...
  it('renders correct page numbers for small totals without ellipses', () => {
    ...
    expect(document.querySelector('.nui-pagination-ellipsis')).not.toBeInTheDocument();
  });
  ...
  it('renders ellipses for large totals to prevent UI overflow', () => {
    ...
    const ellipses = document.querySelectorAll('.nui-pagination-ellipsis');
  ...
  it('marks the current page with aria-current="page"', () => {
    ...
    expect(page3).toHaveClass('nui-pagination-btn--active');
