...
describe('Button Component', () => {
  describe('Rendering', () => {
    ...
    it('renders loading spinner when isLoading is true', () => {
      ...
      expect(document.querySelector('.nui-btn__spinner')).toBeInTheDocument();
    });
    ...
    it('applies variant and size classes', () => {
      ...
      expect(btn.className).toContain('nui-btn--primary');
      expect(btn.className).toContain('nui-btn--lg');
    });
  });
