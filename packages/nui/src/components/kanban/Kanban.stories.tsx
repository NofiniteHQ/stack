        ...
        content: (
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-blue-100 text-primary dark:bg-blue-900/30 dark:text-primary">
                DESIGN
              </span>
            </div>
            <strong>Design System Audit</strong>
            <p className="text-muted mt-1 text-xs">
              Review all semantic colors
            </p>
          </div>
        ),
      },
      {
        ...
        content: (
          <div>
            ...
            <strong>Create Kanban</strong>
            <p className="text-muted mt-1 text-xs">Implement drag and drop</p>
          </div>
        ),
      },
      {
    ...
    items: [
      {
        ...
        content: (
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400">
                TECH DEBT
              </span>
            </div>
    ...
    items: [
      {
        ...
        content: (
          <div>
            ...
            <strong>Setup repository</strong>
          </div>
        ),
      },
      {
        ...
        content: (
          <div>
            ...
            <strong>Initial styling pass</strong>
          </div>
        ),
      },
    ],
  ...
  return columns.map((col) => ({
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="p-1 text-muted hover:text-default bg-transparent hover:bg-slate-200 dark:hover:bg-slate-700 border-none outline-none shadow-none rounded-md transition-colors"
          >
    ...
    footer: (
      <button
        ...
        className="flex items-center gap-2 w-full px-2 py-1.5 text-sm font-medium text-muted hover:text-default bg-transparent hover:bg-slate-200/50 dark:hover:bg-slate-700/30 border-none outline-none shadow-none rounded-md transition-colors group opacity-70 hover:opacity-100"
      >
...
const KanbanDefaultStory = () => {
  ...
  return (
    <div className="h-[700px] flex flex-col font-sans antialiased bg-slate-50 dark:bg-[#0a0a0b] p-6 rounded-xl border border-glassBorder">
      <div className="flex items-center justify-between mb-8 shrink-0">
        <div>
          ...
          <p className="text-muted text-sm mt-1">
            Manage your team's active tasks and progress.
          </p>
        </div>
        <div className="flex -space-x-2">
          ...
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className={`w-8 h-8 rounded-full border-2 border-white dark:border-[#0a0a0b] bg-primary/${
                i * 30
              } flex items-center justify-center text-[10px] font-bold text-primary-foreground z-${
                30 - i * 10
              }`}
            >
              U{i}
      ...
      <Kanban
        columns={enrichWithSlots(columns)}
        onChange={setColumns}
