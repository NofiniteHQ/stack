      ...
      <Drawer {...args} open={open} onClose={() => setOpen(false)}>
        <div className="flex flex-col gap-4">
          <p className="text-default font-sans text-sm m-0">
            This is some standard auxiliary content. You can place forms, lists,
            or any other elements here.
          </p>
...
export const DisableEsc: Story = {
  ...
  args: {
    disableEsc: true,
    title: 'No Escape',
    description: 'Pressing escape will not close this drawer.',
  },
};
...
export const DisableClickOutside: Story = {
  ...
  args: {
    ...
    description: 'Clicking outside will not close this drawer.',
  },
};
