...
describe('Drawer Component', () => {
  ...
  describe('Rendering & Animations', () => {
    it('does not render when closed', () => {
      ...
      const { container } = render(
        <Drawer open={false} onClose={onCloseSpy}>
          Content
        </Drawer>
      );
    ...
    it('renders drawer content and fully opens after timeout', async () => {
      const onCloseSpy = vi.fn();
      render(
        <Drawer open onClose={onCloseSpy}>
          Content
        </Drawer>
      );
  ...
  describe('Interactions', () => {
    ...
    it('does not close on Escape when disableEsc is true', async () => {
      ...
      render(
        <Drawer open disableEsc onClose={onCloseSpy}>
          Content
        </Drawer>
      );
    ...
    it('does not close on outside click when disabled', async () => {
      ...
      render(
        <>
          ...
          <Drawer open disableClickOutside onClose={onCloseSpy}>
            Content
          </Drawer>
        </>
      );
