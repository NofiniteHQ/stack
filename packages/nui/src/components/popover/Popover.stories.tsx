      ...
      <Popover.Content showArrow={args.showArrow}>
        <div className="flex flex-col gap-1 p-1">
          ...
          <p className="m-0 text-sm text-muted">
            This is a headless-style popover component with built-in positioning
            and focus trapping.
          </p>
        </div>
      </Popover.Content>
  ...
  render: () => (
    ...
    >
      <Popover>
        ...
        <Popover.Content placement="top" showArrow>
          <div className="p-2">Top placement</div>
        </Popover.Content>
      </Popover>
      <Popover>
        <Popover.Trigger>
        ...
        <Popover.Content placement="bottom" showArrow>
          <div className="p-2">Bottom placement</div>
        </Popover.Content>
      </Popover>
      <Popover>
        <Popover.Trigger>
        ...
        <Popover.Content placement="left" showArrow>
          <div className="p-2">Left placement</div>
        </Popover.Content>
      </Popover>
      <Popover>
        <Popover.Trigger>
        ...
        <Popover.Content placement="right" showArrow>
          <div className="p-2">Right placement</div>
        </Popover.Content>
      </Popover>
    </div>
  ),
    ...
    <Popover>
      ...
      <Popover.Content>
        <div className="flex flex-col gap-4">
          ...
          <input
            type="text"
            placeholder="Focus is trapped here"
            className="rounded border px-2 py-1 text-sm bg-surface"
          />
        </div>
      </Popover.Content>
    </Popover>
