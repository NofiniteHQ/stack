...
export const EditorDragHandle: React.FC<EditorDragHandleProps> = ({
  editor,
}) => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      while (
        ...
        !blockNode.parentElement.classList.contains('ProseMirror')
      ) {
      ...
      if (
        ...
        setHandleStyle({
          ...
          left: 2, // 2px from the left edge of the container
          pointerEvents: 'auto',
        });
      } else {
  ...
  return (
    <div
      ...
      className="absolute flex items-center justify-center w-5 h-5 rounded cursor-grab active:cursor-grabbing text-muted hover:bg-subtle hover:text-default transition-opacity duration-150 z-50"
      style={handleStyle}
    >
