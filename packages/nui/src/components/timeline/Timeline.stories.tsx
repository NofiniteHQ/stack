...
const mockItems: TimelineItem[] = [
  {
    ...
    description:
      'Initial meeting with stakeholders to discuss the scope and requirements of the new UI component library.',
    status: 'success',
  },
  {
    id: '2',
    ...
    description:
      'The core aesthetic including glassmorphism and semantic tokens has been signed off by the design team.',
    status: 'primary',
  },
  {
    id: '3',
    ...
    description:
      'Currently building advanced components like Kanban and Timeline.',
    status: 'warning',
  },
  {
    id: '4',
  ...
  render: () => (
    <Timeline orientation="vertical">
      <Timeline.Item>
        ...
        <Timeline.Content
          time="10:00 AM"
          title="Primitive Node 1"
          description="This node was manually composed using the underlying primitives."
        />
      </Timeline.Item>
      <Timeline.Item>
        ...
        <Timeline.Content
          time="11:30 AM"
          title="Primitive Node 2"
          description="No data prop required."
        />
      </Timeline.Item>
    </Timeline>
  ),
