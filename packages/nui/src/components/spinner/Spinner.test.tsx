...
describe('Spinner Component', () => {
  ...
  it('applies the correct size classes', () => {
    ...
    expect(screen.getByTestId('spinner')).toHaveClass('nui-spinner--xl');
  });

  it('applies variant classes for styling', () => {
    render(<Spinner variant="inverse" data-testid="spinner" />);
    expect(screen.getByTestId('spinner')).toHaveClass('nui-spinner--inverse');
  });
  ...
  it('includes an SVG for the visual animation', () => {
    ...
    expect(svg).toHaveClass('nui-spinner__svg');
