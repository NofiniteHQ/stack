  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'link-preview link-preview-card w-full max-w-2xl select-none relative group',
          className
        )}
        {...props}
      >
          ...
          {loading ? (
            ...
            <div className="flex flex-col sm:flex-row h-full">
              <div className="flex flex-1 flex-col justify-between p-4 order-2 sm:order-1 min-w-0">
                <div>
                  <h3 className="text-base font-semibold text-default truncate mb-1 group-hover:text-primary transition-colors">
                    {title || url}
                  </h3>
