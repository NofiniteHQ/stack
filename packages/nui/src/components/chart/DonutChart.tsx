        ...
        >
          <div className="flex items-center gap-2 mb-1">
            <span
              ...
              style={{
                backgroundColor: colorScale(labelAccessor(tooltipData)),
              }}
            />
...
export function DonutChart<T>(
  props: Omit<DonutChartProps<T>, 'width' | 'height'>
) {
  return (
    <div
    ...
    >
      <ParentSize>
        {({ width, height }) => (
          <BaseDonutChart width={width} height={height} {...props} />
        )}
      </ParentSize>
    </div>
  );
